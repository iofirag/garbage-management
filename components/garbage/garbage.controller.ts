...
export module GarbageCtrl {
    ...
    export async function updateFieldById(req: Request, res: Response, next?: NextFunction): Promise<Response> {
        try {
            // Data validation
            const {id} = req.params
    ...
    export async function getById(req: Request, res: Response, next?: NextFunction): Promise<Response> {
        try {
            // Data validation
            const {id} = req.params
            if (!id) {
    ...
    export async function getAll(req: Request, res: Response, next?: NextFunction): Promise<Response> {
        try {
    ...
    export async function getByLocationRange(req: Request, res: Response, next?: NextFunction): Promise<Response> {
        try {
            // Data validations
    ...
    export async function getByEmptyDate(req: Request, res: Response, next?: NextFunction): Promise<Response> {
        try {
            // Data validations
    ...
    export async function _delete(req: Request, res: Response, next?: NextFunction): Promise<Response> {
        try {
            // Data validations
            const {id} = req.params
    ...
    export async function createAndFetchTest(req: Request, res: Response, next?: NextFunction): Promise<Response> {
        try {
            // Data validation
            const {color, type, location, emptyDate} = req.body
            if (!color || !('type' in req.body) || !location || !emptyDate) return res.json({error: 'missing data'})
